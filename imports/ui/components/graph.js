...
function renderGraph(graph, container, level) {
    let cy = cytoscape({
        ...
        style: [ // the stylesheet for the graph
            ...
            {
                selector: 'node[id ^= "Act"]', // All nodes with ID Activity
                style: {
                    'shape': 'polygon',
...

            {
                ...
                style: {
                    'shape': 'polygon',
                    'shape-polygon-points': '-0.91 0.9 -0.93 0.91 -0.94 0.91 -0.94 0.93 -0.95 0.94 -0.95 0.95 -0.95 0.96 -0.94 0.98 -0.94 0.99 -0.93 0.99 -0.91 1 -0.9 1 -0.89 1 -0.88 0.99 -0.86 0.99 -0.86 0.98 -0.85 0.96 -0.85 0.95 -0.85 0.95 -0.85 0.94 -0.86 0.93 -0.86 0.91 -0.88 0.91 -0.89 0.9 -0.89 0.55 0.88 0.04 0.89 0.05 0.9 0.05 0.91 0.05 0.93 0.04 0.94 0.04 0.94 0.03 0.95 0.01 0.95 0 0.95 0 0.95 -0.01 0.94 -0.03 0.94 -0.04 0.93 -0.04 0.91 -0.05 0.9 -0.05 0.89 -0.05 0.88 -0.04 0.86 -0.04 0.86 -0.03 0.85 -0.01 0.85 0 -0.89 0.5 -0.89 -0.9 -0.81 -0.9 -0.9 -1 -0.99 -0.9 -0.91 -0.9',
                    'height': 70,
                    'width': 70,
                }
            },
