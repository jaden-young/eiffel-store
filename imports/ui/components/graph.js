    ...
    let cy = cytoscape({
        ...
        style: [ // the stylesheet for the graph
...

            {
                ...
                style: {
                    'shape': 'polygon',
                    'shape-polygon-points': '-0.43 -0.9 -0.41 -0.92 -0.38 -0.94 -0.36 -0.96 -0.33 -0.97 -0.31 -0.98 -0.28 -0.99 -0.26 -1 -0.23 -1 -0.2 -1 -0.18 -1 -0.15 -0.99 -0.13 -0.98 -0.1 -0.97 -0.08 -0.96 -0.05 -0.94 -0.03 -0.92 0 -0.9 0.43 -0.9 0.41 -0.88 0.38 -0.86 0.36 -0.84 0.33 -0.83 0.31 -0.82 0.28 -0.81 0.26 -0.8 0.23 -0.8 0.2 -0.8 0.18 -0.8 0.15 -0.81 0.13 -0.82 0.1 -0.83 0.08 -0.84 0.05 -0.86 0.03 -0.88 0 -0.9 0.43 -0.1 0.41 -0.08 0.38 -0.06 0.36 -0.04 0.33 -0.03 0.31 -0.02 0.28 -0.01 0.26 0 0.23 0 0.2 0 0.18 0 0.15 -0.01 0.13 -0.02 0.1 -0.03 0.08 -0.04 0.05 -0.06 0.03 -0.08 0 -0.1 -0.43 -0.1 -0.41 -0.12 -0.38 -0.14 -0.36 -0.16 -0.33 -0.17 -0.31 -0.18 -0.28 -0.19 -0.26 -0.2 -0.23 -0.2 -0.2 -0.2 -0.18 -0.2 -0.15 -0.19 -0.13 -0.18 -0.1 -0.17 -0.08 -0.16 -0.05 -0.14 -0.03 -0.12 0 -0.1',
                    'height': 40,
                    'width': 40,
                    'background-color': FAIL_COLOR,
                    'background-position-x': '0px',
            ...
            {
                selector: 'node[id ^= "EDef"]', // All nodes with ID Sourcs Change Submitted
                style: {
                    'shape': 'polygon',
